        ...
        (a.generateAxis = function () {
            function t(a) {
                a.each(function () {
                    ...
                    n.isCategory ? ((e.tickOffset = Math.ceil((d(1) - d(0)) / 2)), (r = e.tickCentered ? 0 : e.tickOffset), (o = e.tickCentered ? e.tickOffset : 0)) : (e.tickOffset = r = 0),
                        h.append("line"),
                        h.append("text"),
                        e.updateRange(),
                        e.updateTickLength(),
                    ...
                    switch (e.orient) {
                        ...
                        case "top":
                            (a = e.axisX),
                                ...
                                _.attr("x", 0).attr("y", -e.tickLength).style("text-anchor", "middle"),
                        ...
                        case "left":
                            (a = e.axisY),
                                ...
                                _.attr("x", -e.tickLength).attr("y", e.tickOffset).style("text-anchor", "end"),
                        ...
                        case "right":
                            (a = e.axisY),
                                ...
                                _.attr("x", e.tickLength).attr("y", 0).style("text-anchor", "start"),
                                x.attr("x", e.tickLength).attr("dy", function (t, i) {
                                    return e.tspanDy(t, i);
                                }),
                                y.attr("d", "M" + e.outerTickSize + "," + e.range[0] + "H0V" + e.range[1] + "H" + e.outerTickSize);
    ...
    ((n = A.prototype).init = function () {
        ...
        (n.getXAxis = function (t, e, i, n, a, r, o) {
            ...
            return (
                ...
                s.isCategorized() && (l.tickCentered(c.axis_x_tick_centered), y(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
                l
            );
        }),
        ...
        (n.getMaxTickWidth = function (t, e) {
            ...
            return e && o.currentMaxTickWidths[t]
                ...
                : (o.svg &&
                      ...
                      "y" === t
                          ? ((n = o.y.copy().domain(o.getYDomain(i, "y"))), (a = this.getYAxis(n, o.yOrient, s.axis_y_tick_format, o.yAxisTickValues, !1, !0, !0)))
                          : "y2" === t
                          ? ((n = o.y2.copy().domain(o.getYDomain(i, "y2"))), (a = this.getYAxis(n, o.y2Orient, s.axis_y2_tick_format, o.y2AxisTickValues, !1, !0, !0)))
                          : ((n = o.x.copy().domain(o.getXDomain(i))), (a = this.getXAxis(n, o.xOrient, o.xAxisTickFormat, o.xAxisTickValues, !1, !0, !0)), this.updateXAxisTickValues(i, a)),
        ...
        (n.generateTransitions = function (t) {
            ...
            return { axisX: t ? e.x.transition().duration(t) : e.x, axisY: t ? e.y.transition().duration(t) : e.y, axisY2: t ? e.y2.transition().duration(t) : e.y2, axisSubX: t ? e.subx.transition().duration(t) : e.subx };
        }),
    ...
    return (
        ...
        (C.initParams = function () {
            ...
            (t.clipId = "c3-" + +new Date() + "-clip"),
                ...
                (t.dataTimeFormat = i.data_xLocaltime ? e.time.format : e.time.format.utc),
        ...
        (C.initWithData = function (t) {
            ...
            (n.axis = new A(n)),
                ...
                o.bindto ? ("function" == typeof o.bindto.node ? (n.selectChart = o.bindto) : (n.selectChart = a.select(o.bindto))) : (n.selectChart = a.selectAll([])),
                n.selectChart.empty() && ((n.selectChart = a.select(document.createElement("div")).style("opacity", 0)), n.observeInserted(n.selectChart), (s = !1)),
                n.selectChart.html("").classed("c3", !0),
                (n.data.xs = {}),
                (n.data.targets = n.convertDataToTargets(t)),
                o.data_filter && (n.data.targets = n.data.targets.filter(o.data_filter)),
                o.data_hide && n.addHiddenTargetIds(!0 === o.data_hide ? n.mapToIds(n.data.targets) : o.data_hide),
                o.legend_hide && n.addHiddenLegendIds(!0 === o.legend_hide ? n.mapToIds(n.data.targets) : o.legend_hide),
                ...
                s && (n.updateDimension(), n.config.oninit.call(n), n.redraw({ withTransition: !1, withTransform: !0, withUpdateXDomain: !0, withUpdateOrgXDomain: !0, withTransitionForAxis: !1 })),
                n.bindResize(),
        ...
        (C.updateSizes = function () {
            ...
            (t.currentWidth = t.getCurrentWidth()),
                ...
                (t.margin = e.axis_rotated
                    ...
                    : { top: 4 + t.getCurrentPaddingTop(), right: r ? 0 : t.getCurrentPaddingRight(), bottom: o + s + a + t.getCurrentPaddingBottom(), left: r ? 0 : t.getCurrentPaddingLeft() }),
                (t.margin2 = e.axis_rotated ? { top: t.margin.top, right: NaN, bottom: 20 + a, left: t.rotated_padding_left } : { top: t.currentHeight - s - a, right: NaN, bottom: o + a, left: t.margin.left }),
                ...
                t.isLegendRight && r && (t.margin3.left = t.arcWidth / 2 + 1.1 * t.radiusExpanded);
        }),
        ...
        (C.redraw = function (t, e) {
            ...
            if (
                ...
                h && D.legend_show ? I.updateLegend(I.mapToIds(I.data.targets), t, e) : f && I.updateDimension(!0),
                I.isCategorized() && 0 === H.length && I.x.domain([0, I.axes.x.selectAll(".tick").size()]),
                H.length ? (I.updateXDomain(H, d, l, u), D.axis_x_tick_values || (C = I.axis.updateXAxisTickValues(H))) : (I.xAxis.tickValues([]), I.subXAxis.tickValues([])),
                D.zoom_rescale && !t.flow && (G = I.x.orgDomain()),
                I.y.domain(I.getYDomain(H, "y", G)),
                I.y2.domain(I.getYDomain(H, "y2", G)),
                !D.axis_y_tick_values && D.axis_y_tick_count && I.yAxis.tickValues(I.axis.generateTickValues(I.y.domain(), D.axis_y_tick_count)),
            ...
            (_ = I.generateDrawArea ? I.generateDrawArea(F, !1) : void 0),
                ...
                i && (I.subY.domain(I.getYDomain(H, "y")), I.subY2.domain(I.getYDomain(H, "y2"))),
                I.updateXgridFocus(),
                ...
                t.flow && (P = I.generateFlow({ targets: H, flow: t.flow, duration: t.flow.duration, drawBar: x, drawLine: m, drawArea: _, cx: E, cy: O, xv: B, xForText: y, yForText: S })),
                (v || P) && I.isTabVisible()
                    ? k
                          .transition()
                          .duration(v)
                    ...
                    : (I.redrawBar(x), I.redrawLine(m), I.redrawArea(_), I.redrawCircle(E, O), I.redrawText(y, S, t.flow), I.redrawRegion(), I.redrawGrid(), D.onrendered && D.onrendered.call(I)),
        ...
        (C.updateAndRedraw = function (t) {
            ...
            ((t = t || {}).withTransition = w(t, "withTransition", !0)),
                ...
                (t.withTransitionForTransform = w(t, "withTransitionForTransform", t.withTransition)),
                i.updateSizes(),
                (t.withLegend && n.legend_show) || ((e = i.axis.generateTransitions(t.withTransitionForAxis ? n.transition_duration : 0)), i.updateScales(), i.updateSvgSize(), i.transformAll(t.withTransitionForTransform, e)),
                i.redraw(t, e);
        }),
        ...
        (C.transformMain = function (t, e) {
            var i,
                ...
                a,
                o = this;
            e && e.axisX ? (i = e.axisX) : ((i = o.main.select("." + r.axisX)), t && (i = i.transition())),
                e && e.axisY ? (n = e.axisY) : ((n = o.main.select("." + r.axisY)), t && (n = n.transition())),
                e && e.axisY2 ? (a = e.axisY2) : ((a = o.main.select("." + r.axisY2)), t && (a = a.transition())),
                (t ? o.main.transition() : o.main).attr("transform", o.getTranslate("main")),
                i.attr("transform", o.getTranslate("x")),
                n.attr("transform", o.getTranslate("y")),
                a.attr("transform", o.getTranslate("y2")),
                o.main.select("." + r.chartArcs).attr("transform", o.getTranslate("arc"));
        }),
                          ...
                          "childList" === n.type &&
                              ...
                              (i.intervalForObserveInserted = window.setInterval(function () {
                                  t.node().parentNode &&
                                      ...
                                      i.redraw({ withTransform: !0, withUpdateXDomain: !0, withUpdateOrgXDomain: !0, withTransition: !1, withTransitionForTransform: !1, withLegend: !0 }),
                                      t.transition().style("opacity", 1));
                              }, 10)));
                      });
                  })).observe(t.node(), { attributes: !0, childList: !0, characterData: !0 })
                ...
                (n.prototype._isCurrentSpace = function () {
                    ...
                    (n.prototype._skipOptionalSpacesOrDelimiter = function () {
                        return (
                            ...
                            (this._skipOptionalSpaces() && this._currentIndex < this._endIndex && "," == this._string.charAt(this._currentIndex) && (this._currentIndex++, this._skipOptionalSpaces()), this._currentIndex < this._endIndex)
                        );
                    }),
                    ...
                    (n.prototype._parseNumber = function () {
                        ...
                        if (
                            ...
                            this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex)
                                ? this._currentIndex++
                                : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, (a = -1)),
                    ...
                    (n.prototype.parseSegment = function () {
                        ...
                        switch (((this._previousCommand = i), i)) {
                            ...
                            case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_REL:
                                return (n = { x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() }), new window.SVGPathSegCurvetoCubicSmoothRel(e, n.x, n.y, n.x2, n.y2);
                            case window.SVGPathSeg.PATHSEG_CURVETO_CUBIC_SMOOTH_ABS:
                                return (n = { x2: this._parseNumber(), y2: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() }), new window.SVGPathSegCurvetoCubicSmoothAbs(e, n.x, n.y, n.x2, n.y2);
                            case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_REL:
                                return (n = { x1: this._parseNumber(), y1: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() }), new window.SVGPathSegCurvetoQuadraticRel(e, n.x, n.y, n.x1, n.y1);
                            case window.SVGPathSeg.PATHSEG_CURVETO_QUADRATIC_ABS:
                                return (n = { x1: this._parseNumber(), y1: this._parseNumber(), x: this._parseNumber(), y: this._parseNumber() }), new window.SVGPathSegCurvetoQuadraticAbs(e, n.x, n.y, n.x1, n.y1);
                            ...
                            case window.SVGPathSeg.PATHSEG_ARC_REL:
                                return (
                                    (n = { x1: this._parseNumber(), y1: this._parseNumber(), arcAngle: this._parseNumber(), arcLarge: this._parseArcFlag(), arcSweep: this._parseArcFlag(), x: this._parseNumber(), y: this._parseNumber() }),
                                    new window.SVGPathSegArcRel(e, n.x, n.y, n.x1, n.y1, n.arcAngle, n.arcLarge, n.arcSweep)
                                );
                            case window.SVGPathSeg.PATHSEG_ARC_ABS:
                                var n = { x1: this._parseNumber(), y1: this._parseNumber(), arcAngle: this._parseNumber(), arcLarge: this._parseArcFlag(), arcSweep: this._parseArcFlag(), x: this._parseNumber(), y: this._parseNumber() };
        ...
        (P.axis.max = function (t) {
            ...
            "object" === (void 0 === t ? "undefined" : o(t)) ? (l(t.x) && (i.axis_x_max = t.x), l(t.y) && (i.axis_y_max = t.y), l(t.y2) && (i.axis_y2_max = t.y2)) : (i.axis_y_max = i.axis_y2_max = t),
        ...
        (P.axis.min = function (t) {
            ...
            "object" === (void 0 === t ? "undefined" : o(t)) ? (l(t.x) && (i.axis_x_min = t.x), l(t.y) && (i.axis_y_min = t.y), l(t.y2) && (i.axis_y2_min = t.y2)) : (i.axis_y_min = i.axis_y2_min = t),
                e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 });
        }),
            ...
            (e = c.convertDataToTargets(i, !0)),
                ...
                c.data.targets.forEach(function (t) {
                    ...
                    for (e = 0; e < d.length; e++)
                        if (t.id === d[e]) for (g = t.values[t.values.length - 1].index + 1, i = 0; i < h; i++) t.values.push({ id: t.id, index: g + i, x: c.isTimeSeries() ? c.getOtherTargetX(g + i) : g + i, value: null });
                }),
                c.data.targets.length &&
                    e.forEach(function (t) {
                        var e,
                            i = [];
                        for (e = c.data.targets[0].values[0].index; e < g; e++) i.push({ id: t.id, index: e, x: c.isTimeSeries() ? c.getOtherTargetX(e) : e, value: null });
                ...
                u
                    ? 1 === u && c.isTimeSeries() && ((o = (a.values[a.values.length - 1].x - r.x) / 2), (n = [new Date(+r.x - o), new Date(+r.x + o)]), c.updateXDomain(null, !0, !0, !1, n))
                    : ((o = c.isTimeSeries() ? (a.values.length > 1 ? a.values[a.values.length - 1].x - r.x : r.x - c.getXDomain(c.data.targets)[0]) : 1), (n = [r.x - o, r.x]), c.updateXDomain(null, !0, !0, !1, n)),
                c.updateTargets(c.data.targets),
                c.redraw({
                    flow: { index: r.index, length: h, duration: l(t.duration) ? t.duration : c.config.transition_duration, done: t.done, orgDataCount: u },
                    withLegend: !0,
                    withTransition: u > 1,
                    withTrimXDomain: !1,
                    withUpdateXAxis: !0,
        ...
        (C.generateFlow = function (t) {
            ...
            return function () {
                ...
                (e.flowing = !0),
                    ...
                    d.orgDataCount
                        ? (a = 1 === d.orgDataCount || (b && b.x) === (T && T.x) ? e.x(A[0]) - e.x(s[0]) : e.isTimeSeries() ? e.x(A[0]) - e.x(s[0]) : e.x(b.x) - e.x(T.x))
                        : 1 !== e.data.targets[0].values.length
                        ? (a = e.x(A[0]) - e.x(s[0]))
                        : e.isTimeSeries()
                        ? ((b = e.getValueOnIndex(e.data.targets[0].values, 0)), (T = e.getValueOnIndex(e.data.targets[0].values, e.data.targets[0].values.length - 1)), (a = e.x(b.x) - e.x(T.x)))
                        : (a = m(s) / 2),
                    (S = m(A) / m(s)),
                    ...
                    n
                        ...
                        .each(function () {
                            L.add(e.axes.x.transition().call(e.xAxis)),
                                ...
                                L.add(E.filter(e.isRegionOnX).transition().attr("transform", o)),
                        ...
                        .call(L, function () {
                            ...
                            V.attr("transform", null).attr(e.xgridAttr),
                                ...
                                O.attr("transform", null).attr("x", _).attr("y", x).style("fill-opacity", e.opacityForText.bind(e)),
                                E.attr("transform", null),
                                E.select("rect").filter(e.isRegionOnX).attr("x", e.regionX.bind(e)).attr("width", e.regionWidth.bind(e)),
        ...
        (P.revert = function (t) {
            var e = this.internal;
            (t = e.mapToTargetIds(t)),
                e.svg.selectAll(e.selectorTargets(t)).classed(r.focused, !1).classed(r.defocused, !1),
                e.hasArcType() && e.unexpandArc(t),
        ...
        (P.load = function (t) {
            ...
            t.xs && e.addXs(t.xs),
                ...
                "cacheIds" in t && e.hasCaches(t.cacheIds)
                    ...
                    : "unload" in t
                    ? e.unload(e.mapToTargetIds("boolean" == typeof t.unload && t.unload ? null : t.unload), function () {
                          e.loadFromArgs(t);
                      })
                    : e.loadFromArgs(t);
        }),
        ...
        (P.tooltip.show = function (t) {
            ...
            t.mouse && (i = t.mouse),
                t.data
                    ? n.isMultipleX()
                        ? ((i = [n.x(t.data.x), n.getYScale(t.data.id)(t.data.value)]), (e = null))
        ...
        (P.x = function (t) {
            var e = this.internal;
            return arguments.length && (e.updateTargetX(e.data.targets, t), e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 })), e.data.xs;
        }),
        (P.xs = function (t) {
            var e = this.internal;
            return arguments.length && (e.updateTargetXs(e.data.targets, t), e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 })), e.data.xs;
        }),
        (P.zoom = function (t) {
            var e = this.internal;
            return (
        ...
        (C.updateArc = function () {
            var t = this;
            (t.svgArc = t.getSvgArc()), (t.svgArcExpanded = t.getSvgArcExpanded()), (t.svgArcExpandedSub = t.getSvgArcExpanded(0.98));
        }),
                            ...
                            (r =
                                o.hasType("donut") && s.donut_label_ratio
                                    ...
                                    ? u(s.pie_label_ratio)
                                        ...
                                        : s.pie_label_ratio
                                    : o.radius && a
                                    ? ((36 / o.radius > 0.375 ? 1.175 - 36 / o.radius : 0.8) * o.radius) / a
                                    : 0) +
                        "," +
                        n * r +
                        ")")),
        ...
        (C.textForArcLabel = function (t) {
            ...
            return o.shouldShowArcLabel()
                ? ((e = o.updateAngle(t)),
                  ...
                  (n = o.getArcRatio(e)),
                  (a = t.data.id),
                  o.hasType("gauge") || o.meetsArcLabelThreshold(n) ? ((r = o.getArcLabelFormat()), r ? r(i, n, a) : o.defaultArcValueFormat(i, n)) : "")
                : "";
        }),
        ...
        (C.expandArc = function (t) {
            ...
            i.transiting
                ...
                : ((t = i.mapToTargetIds(t)),
                  i.svg.selectAll(i.selectorTargets(t, "." + r.chartArc)).each(function (t) {
        ...
        (C.initArc = function () {
            ...
            (t.arcs = t.main
                ...
                t.arcs.append("text").attr("class", r.chartArcsTitle).style("text-anchor", "middle").text(t.getArcTitle());
        }),
        (C.redrawArc = function (t, e, i) {
            ...
            (n = c
                ...
                c.select("." + r.chartArcsTitle).style("opacity", a.hasType("donut") || a.hasType("gauge") ? 1 : 0),
                a.hasType("gauge") &&
                    (a.arcs.select("." + r.chartArcsBackground).attr("d", function () {
                        var t = { data: [{ value: s.gauge_max }], startAngle: s.gauge_startingAngle, endAngle: -1 * s.gauge_startingAngle };
                    ...
                    a.arcs
                        ...
                        .attr("dx", -1 * (a.innerRadius + (a.radius - a.innerRadius) / (s.gauge_fullCircle ? 1 : 2)) + "px")
                        .attr("dy", "1.2em")
                        .text(s.gauge_label_show ? a.textForGaugeMinMax(s.gauge_min, !1) : ""),
                    a.arcs
                        .select("." + r.chartArcsGaugeMax)
                        .attr("dx", a.innerRadius + (a.radius - a.innerRadius) / (s.gauge_fullCircle ? 1 : 2) + "px")
                        .attr("dy", "1.2em")
                        .text(s.gauge_label_show ? a.textForGaugeMinMax(s.gauge_max, !0) : ""));
        }),
        (C.initGauge = function () {
            var t = this.arcs;
            this.hasType("gauge") &&
                (t.append("path").attr("class", r.chartArcsBackground),
                t.append("text").attr("class", r.chartArcsGaugeUnit).style("text-anchor", "middle").style("pointer-events", "none"),
                t.append("text").attr("class", r.chartArcsGaugeMin).style("text-anchor", "middle").style("pointer-events", "none"),
                t.append("text").attr("class", r.chartArcsGaugeMax).style("text-anchor", "middle").style("pointer-events", "none"));
        }),
        ...
        (C.convertJsonToData = function (t, e) {
            ...
            return (
                e
                    ? (e.x ? ((i = e.value.concat(e.x)), (a.config.data_x = e.x)) : (i = e.value),
                      r.push(i),
                      t.forEach(function (t) {
                          var e = [];
                ...
                r.forEach(function (i) {
                    ...
                    n.isCustomX() || n.isTimeSeries()
                        ? o.indexOf(r) >= 0
                            ...
                            : S(a.data_xs) && (n.data.xs[i] = n.getXValuesOfXKey(r, n.data.targets))
                            ...
                            .map(function (t, o) {
                                ...
                                return (
                                    n.isCustomX() && n.isCategorized() && void 0 !== c
                                        ? (0 === i && 0 === o && (a.axis_x_categories = []), -1 === (s = a.axis_x_categories.indexOf(c)) && ((s = a.axis_x_categories.length), a.axis_x_categories.push(c)))
        ...
        (C.load = function (t, e) {
            ...
            t &&
                ...
                i.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0, withLegend: !0 }),
                e.done && e.done();
        }),
            ...
            e || (e = function () {}),
                (t = t.filter(function (t) {
                    ...
                    ? (i.svg
                      ...
                      t.forEach(function (t) {
                          (i.withoutFadeIn[t] = !1),
                              i.legend && i.legend.selectAll("." + r.legendItem + i.getTargetSelectorSuffix(t)).remove(),
            ...
            return (
                ...
                0 === x.length
                    ...
                    : (isNaN(v) && (v = 0),
                      ...
                      (a = Math.abs(b - v)),
                      (r = o = 0.1 * a),
                      void 0 !== T && ((b = T + (s = Math.max(Math.abs(v), Math.abs(b)))), (v = T - s)),
                      C
                          ? ((c = f.getDataLabelLength(v, b, "width")), (d = m(f.y.range())), (r += a * ((u = [c[0] / d, c[1] / d])[1] / (1 - u[0] - u[1]))), (o += a * (u[0] / (1 - u[0] - u[1]))))
                          : L && ((c = f.getDataLabelLength(v, b, "height")), (r += f.axis.convertPixelsToAxisPadding(c[1], a)), (o += f.axis.convertPixelsToAxisPadding(c[0], a))),
                      "y" === e && S(p.axis_y_padding) && ((r = f.axis.getPadding(p.axis_y_padding, "top", r, a)), (o = f.axis.getPadding(p.axis_y_padding, "bottom", o, a))),
                      "y2" === e && S(p.axis_y2_padding) && ((r = f.axis.getPadding(p.axis_y2_padding, "top", r, a)), (o = f.axis.getPadding(p.axis_y2_padding, "bottom", o, a))),
                      A && (h && (o = v), g && (r = -b)),
                      (n = [v - o, b + r]),
                      P ? n.reverse() : n)
            );
        ...
        (C.getXDomainPadding = function (t) {
            var e,
                ...
                c = t[1] - t[0];
            return (
                (i = r.isCategorized() ? 0 : r.hasType("bar") ? ((e = r.getMaxDataCount()) > 1 ? c / (e - 1) / 2 : 0.5) : 0.01 * c),
                "object" === o(s.axis_x_padding) && S(s.axis_x_padding)
                    ? ((n = l(s.axis_x_padding.left) ? s.axis_x_padding.left : i), (a = l(s.axis_x_padding.right) ? s.axis_x_padding.right : i))
                    : (n = a = "number" == typeof s.axis_x_padding ? s.axis_x_padding : i),
                { left: n, right: a }
            );
        }),
        (C.getXDomain = function (t) {
            var e = this,
                ...
                s = 0;
            return (
                n - a != 0 || e.isCategorized() || (e.isTimeSeries() ? ((n = new Date(0.5 * n.getTime())), (a = new Date(1.5 * a.getTime()))) : ((n = 0 === n ? 1 : 0.5 * n), (a = 0 === a ? -1 : 1.5 * a))),
        ...
        (C.updateXDomain = function (t, e, i, n, a) {
            var r = this,
                o = r.config;
            return (
                i && (r.x.domain(a || r.d3.extent(r.getXDomain(t))), (r.orgXDomain = r.x.domain()), o.zoom_enabled && r.zoom.scale(r.x).updateScaleExtent(), r.subX.domain(r.x.domain()), r.brush && r.brush.scale(r.subX)),
                e && (r.x.domain(a || (!r.brush || r.brush.empty() ? r.orgXDomain : r.brush.extent())), o.zoom_enabled && r.zoom.scale(r.x).updateScaleExtent()),
        ...
        (C.initGrid = function () {
            var t = this,
                e = t.config,
                i = t.d3;
            (t.grid = t.main.append("g").attr("clip-path", t.clipPathForGrid).attr("class", r.grid)),
                e.grid_x_show && t.grid.append("g").attr("class", r.xgrids),
                e.grid_y_show && t.grid.append("g").attr("class", r.ygrids),
                e.grid_focus_show && t.grid.append("g").attr("class", r.xgridFocus).append("line").attr("class", r.xgridFocus),
                (t.xgrid = i.selectAll([])),
        ...
        (C.updateGrid = function (t) {
            ...
            a.grid.style("visibility", a.hasArcType() ? "hidden" : "visible"),
                ...
                e
                    ...
                    .attr("dy", -5)
                    .style("opacity", 0),
                a.xgridLines.exit().transition().duration(t).style("opacity", 0).remove(),
                ...
                a.ygridLines
                    ...
                    .style("opacity", 1),
                a.ygridLines.exit().transition().duration(t).style("opacity", 0).remove();
        }),
        (C.redrawGrid = function (t) {
            ...
            return [
                (t ? a.transition() : a)
                    ...
                    .style("opacity", 1),
                (t ? r.transition() : r)
                    .attr("x", i.axis_rotated ? e.yGridTextX.bind(e) : e.xGridTextX.bind(e))
                    .attr("y", n)
                    .text(function (t) {
                        return t.text;
                    })
        ...
        (C.generateGridData = function (t, e) {
            var i,
                ...
                d = s.main
                    ...
                    .selectAll(".tick")
                    .size();
            if ("year" === t) for (n = (i = s.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), o = n; o <= a; o++) c.push(new Date(o + "-01-01 00:00:00"));
            else
        ...
        (C.removeGridLines = function (t, e) {
            ...
            i.main
                ...
                .style("opacity", 0)
                .remove(),
                e ? (n.grid_x_lines = n.grid_x_lines.filter(o)) : (n.grid_y_lines = n.grid_y_lines.filter(o));
        }),
        ...
        (C.redrawEventRect = function () {
            var t,
                ...
                o = i.main
                    .select("." + r.eventRects)
                    .style("cursor", n.zoom_enabled ? (n.axis_rotated ? "ns-resize" : "ew-resize") : null)
            ...
            o.selectAll("." + r.eventRect).remove(),
                ...
                a
                    ? ((t = i.eventRect.data([0])), i.generateEventRectsForMultipleXs(t.enter()), i.updateEventRect(t))
        ...
        (C.updateEventRect = function (t) {
            ...
            (t =
                ...
                t.attr("class", s.classEvent.bind(s)).attr("x", e).attr("y", i).attr("width", n).attr("height", a);
        }),
        (C.generateEventRectsForSingleX = function (t) {
            ...
            t.append("rect")
                ...
                .style("cursor", n.data_selection_enabled && n.data_selection_grouped ? "pointer" : null)
                ...
                .on("mousemove", function (t) {
                    ...
                    e.dragging ||
                        e.flowing ||
                        e.hasArcType() ||
                        (e.isStepType(t) && "step-after" === e.config.line_step_type && i.mouse(this)[0] < e.x(e.getXValue(t.id, o)) && (o -= 1),
                        ...
                        (!n.tooltip_grouped || (n.data_selection_enabled && !n.data_selection_grouped)) &&
                            e.main
                                .selectAll("." + r.shape + "-" + o)
                                .each(function () {
                                    i.select(this).classed(r.EXPANDED, !0),
                                        n.data_selection_enabled && s.style("cursor", n.data_selection_grouped ? "pointer" : null),
                                        n.tooltip_grouped || (e.hideXGridFocus(), e.hideTooltip(), n.data_selection_grouped || (e.unexpandCircles(o), e.unexpandBars(o)));
                                })
                                .filter(function (t) {
                                ...
                                .each(function (t) {
                                    n.data_selection_enabled && (n.data_selection_grouped || n.data_selection_isselectable(t)) && s.style("cursor", "pointer"),
                                        n.tooltip_grouped || (e.showTooltip([t], this), e.showXGridFocus([t]), n.point_focus_expand_enabled && e.expandCircles(o, t.id, !0), e.expandBars(o, t.id, !0));
                                }));
                })
                .on("click", function (t) {
                    var a = t.index;
                    !e.hasArcType() &&
                        ...
                        (e.cancelClick
                            ? (e.cancelClick = !1)
                            : (e.isStepType(t) && "step-after" === n.line_step_type && i.mouse(this)[0] < e.x(e.getXValue(t.id, a)) && (a -= 1),
            ...
            t.append("rect")
                ...
                .on("mousemove", function () {
                    ...
                    i.dragging ||
                        ...
                        !i.mouseover || (o && o.id === i.mouseover.id) || (a.data_onmouseout.call(i.api, i.mouseover), (i.mouseover = void 0)),
                        o
                            ? ((s = (i.isScatterType(o) || !a.tooltip_grouped ? [o] : i.filterByX(c, o.x)).map(function (t) {
                                  return i.addName(t);
                              })),
                              i.showTooltip(s, this),
                              a.point_focus_expand_enabled && i.expandCircles(o.index, o.id, !0),
                              i.expandBars(o.index, o.id, !0),
                              i.showXGridFocus(s),
                              (i.isBarType(o.id) || i.dist(o, t) < a.point_sensitivity) && (i.svg.select("." + r.eventRect).style("cursor", "pointer"), i.mouseover || (a.data_onmouseover.call(i.api, o), (i.mouseover = o))))
                            : e());
                })
                .on("click", function () {
                    var t,
        ...
        (C.initLegend = function () {
            var t = this;
            if (((t.legendItemTextBox = {}), (t.legendHasRendered = !1), (t.legend = t.svg.append("g").attr("transform", t.getTranslate("legend"))), !t.config.legend_show))
        ...
        (C.updateLegendWithDefaults = function () {
            var t = this;
            t.updateLegend(t.mapToIds(t.data.targets), { withTransform: !1, withTransitionForTransform: !1, withTransition: !1 });
        }),
        (C.updateSizeForLegend = function (t, e) {
            ...
            i.margin3 = { top: i.isLegendRight ? 0 : i.isLegendInset ? a.top : i.currentHeight - t, right: NaN, bottom: 0, left: i.isLegendRight ? i.currentWidth - e : i.isLegendInset ? a.left : 0 };
        }),
        ...
        (C.updateLegend = function (t, e, i) {
            ...
            (t = t.filter(function (t) {
                ...
                b.isLegendInset && ((F = T.legend_inset_step ? T.legend_inset_step : t.length), b.updateLegendStep(F)),
                b.isLegendRight
                    ? ((o = function (t) {
                          return C * D[t];
                      }),
                ...
                (_ ? S.transition() : S).style("stroke", b.color).attr("x1", h).attr("y1", f).attr("x2", g).attr("y2", f),
                v && (_ ? v.transition() : v).attr("height", b.getLegendHeight() - 12).attr("width", C * (F + 1) + 10),
                b.legend.selectAll("." + r.legendItem).classed(r.legendItemHidden, function (t) {
        ...
        (C.regionHeight = function (t) {
            var e,
                ...
                r = "y" === t.axis ? i.y : i.y2;
            return (
                (e = "y" === t.axis || "y2" === t.axis ? (n.axis_rotated ? i.height : "start" in t ? r(t.start) : i.height) : n.axis_rotated && "end" in t ? i.x(i.isTimeSeries() ? i.parseDate(t.end) : t.end) : i.height), e < a ? 0 : e - a
            );
        }),
        ...
        (C.updateScales = function () {
            ...
            (t.xMin = e.axis_rotated ? 1 : 0),
                ...
                (t.x = t.getX(t.xMin, t.xMax, i ? void 0 : t.x.orgDomain(), function () {
                ...
                i || (t.brush && t.brush.scale(t.subX), e.zoom_enabled && t.zoom.scale(t.x)),
        ...
        (C.toggleShape = function (t, e, i) {
            ...
            o.data_selection_enabled &&
                ...
                (o.data_selection_multiple ||
                    n.main
                        .selectAll("." + r.shapes + (o.data_selection_grouped ? n.getTargetSelectorSuffix(e.id) : ""))
                        .selectAll("." + r.shape)
                        .each(function (t, e) {
                            var i = a.select(this);
        ...
        (C.updateBar = function (t) {
            ...
            (e.mainBar = e.main
                ...
                .selectAll("." + r.bar)
                .data(i)),
                e.mainBar.enter().append("path").attr("class", n).style("stroke", o).style("fill", o),
        ...
        (C.generateGetBarPoints = function (t, e) {
            ...
            return function (t, e) {
                var n = l.call(i, t.id)(0),
                    ...
                    h = s(t);
                return (
                    i.config.axis_rotated && ((0 < t.value && h < n) || (t.value < 0 && n < h)) && (h = n),
                    [
                        [u + d, a],
                        [u + d, h - (n - a)],
                        [u + r - d, h - (n - a)],
        ...
        (C.getShapeIndices = function (t) {
            var e,
                ...
                o = 0;
            return (
                n.filterTargetsToShow(n.data.targets.filter(t, n)).forEach(function (t) {
        ...
        (C.isWithinShape = function (t, e) {
            ...
            return (
                n.isTargetToShow(e.id)
                    ? "circle" === t.nodeName
                        ? (i = n.isStepType(e) ? n.isWithinStep(t, n.getYScale(e.id)(e.value)) : n.isWithinCircle(t, 1.5 * n.pointSelectR(e)))
                        : "path" === t.nodeName && (i = !a.classed(r.bar) || n.isWithinBar(t))
                    : (i = !1),
                i
            );
        }),
        ...
        (C.updateTargetsForLine = function (t) {
            ...
            (e = i.main
                ...
                t.forEach(function (t) {
                    i.main
                        .selectAll("." + r.selectedCircles + i.getTargetSelectorSuffix(t.id))
                    ...
                    return (
                        i.isLineType(t)
                            ? n.data_regions[t.id]
                                ...
                                : (i.isStepType(t) && (s = i.convertValuesToStep(s)), (r = a.interpolate(i.getInterpolate(t))(s)))
                            : (s[0] && ((l = c(s[0].x)), (u = d(s[0].value))), (r = n.axis_rotated ? "M " + u + " " + l : "M " + l + " " + u)),
                        r || "M 0 0"
                    );
                }
            );
        ...
        (C.generateGetLinePoints = function (t, e) {
            ...
            return function (t, e) {
                var a = c.call(i, t.id)(0),
                    ...
                    u = o(t);
                return (
                    n.axis_rotated && ((0 < t.value && u < a) || (t.value < 0 && a < u)) && (u = a),
                    [
                        [l, u - (a - d)],
                        [l, u - (a - d)],
                        [l, u - (a - d)],
        ...
        (C.lineWithRegions = function (t, e, i, n) {
            ...
            if (void 0 !== n)
                for (r = 0; r < n.length; r++)
                    (S[r] = {}),
                        void 0 === n[r].start ? (S[r].start = t[0].x) : (S[r].start = _.isTimeSeries() ? _.parseDate(n[r].start) : n[r].start),
                        void 0 === n[r].end ? (S[r].end = t[t.length - 1].x) : (S[r].end = _.isTimeSeries() ? _.parseDate(n[r].end) : n[r].end);
            for (
                f = x.axis_rotated
                    ? function (t) {
                          return i(t.value);
        ...
        (C.generateDrawArea = function (t, e) {
            ...
            return (
                ...
                function (t) {
                    ...
                    return (
                        i.isAreaType(t)
                            ? (i.isStepType(t) && (r = i.convertValuesToStep(r)), (e = a.interpolate(i.getInterpolate(t))(r)))
                            : (r[0] && ((o = i.x(r[0].x)), (s = i.getYScale(t.id)(r[0].value))), (e = n.axis_rotated ? "M " + s + " " + o : "M " + o + " " + s)),
                        e || "M 0 0"
                    );
                }
            );
        ...
        (C.redrawCircle = function (t, e, i) {
            ...
            return [
                (i ? this.mainCircle.transition(Math.random().toString()) : this.mainCircle).style("opacity", this.opacityForCircle.bind(this)).style("fill", this.color).attr("cx", t).attr("cy", e),
                (i ? n.transition(Math.random().toString()) : n).attr("cx", t).attr("cy", e),
            ];
        }),
        ...
        (C.getHorizontalAxisHeight = function (t) {
            ...
            return "x" !== t || i.axis_x_show
                ? "x" === t && i.axis_x_height
                    ...
                    : "y" !== t || i.axis_y_show
                    ? "y2" !== t || i.axis_y2_show
                        ? ("x" === t && !i.axis_rotated && i.axis_x_tick_rotate && (n = 30 + e.axis.getMaxTickWidth(t) * Math.cos((Math.PI * (90 - i.axis_x_tick_rotate)) / 180)),
        ...
        (C.initSubchart = function () {
            ...
            i.style("visibility", n),
                i.append("g").attr("clip-path", t.clipPathForSubchart).attr("class", r.chart),
                i
                    .select("." + r.chart)
                    .append("g")
                    .attr("class", r.chartBars),
                i
                    ...
                    .append("g")
                    .attr("class", r.chartLines),
                i.append("g").attr("clip-path", t.clipPath).attr("class", r.brush).call(t.brush),
                (t.axes.subx = i
                    .append("g")
                    .attr("class", r.axisX)
        ...
        (C.updateTargetsForSubchart = function (t) {
            ...
            a.subchart_show &&
                ...
                n.selectAll("." + r.brush + " rect").attr(a.axis_rotated ? "width" : "height", a.axis_rotated ? i.width2 : i.height2));
        }),
        ...
        (C.redrawSubchart = function (t, e, i, n, a, r, o) {
            ...
            l.context.style("visibility", h.subchart_show ? "visible" : "hidden"),
                h.subchart_show &&
                    (u.event && "zoom" === u.event.type && l.brush.extent(l.x.orgDomain()).update(),
                    t &&
        ...
        (C.redrawForBrush = function () {
            var t = this,
                e = t.x;
            t.redraw({ withTransition: !1, withY: t.config.zoom_rescale, withSubchart: !1, withUpdateXDomain: !0, withDimension: !1 }), t.config.subchart_onbrush.call(t.api, e.orgDomain());
        }),
        ...
        (C.getXForText = function (t, e, i) {
            ...
            return (
                r.config.axis_rotated ? ((a = r.isBarType(e) ? 4 : 6), (n = t[2][1] + a * (e.value < 0 ? -1 : 1))) : (n = r.hasType("bar") ? (t[2][0] + t[0][0]) / 2 : t[0][0]),
                null === e.value && (n > r.width ? (n = r.width - o.width) : n < 0 && (n = 4)),
                n
            );
        }),
        (C.getYForText = function (t, e, i) {
            ...
            return (
                a.config.axis_rotated
                    ...
                    : ((n = t[2][1]), e.value < 0 || (0 === e.value && !a.hasPositiveValue) ? ((n += r.height), a.isBarType(e) && a.isSafari() ? (n -= 3) : !a.isBarType(e) && a.isChrome() && (n += 3)) : (n += a.isBarType(e) ? -3 : -6)),
        ...
        (C.xForTitle = function () {
            ...
            return i.indexOf("right") >= 0
                ? t.currentWidth - t.getTextRect(t.title.node().textContent, t.CLASS.title, t.title.node()).width - e.title_padding.right
                : i.indexOf("center") >= 0
        ...
        (C.getTooltipContent = function (t, e, i, n) {
            ...
            for (p && t.sort(p), r = 0; r < t.length; r++)
                if (
                    ...
                    (a || ((o = b(h ? h(t[r].x) : t[r].x)), (a = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : ""))),
        ...
        (C.tooltipPosition = function (t, e, i, n) {
            ...
            return (
                h
                    ? ((r = (d.width - (d.isLegendRight ? d.getLegendWidth() : 0)) / 2 + g[0]), (s = d.height / 2 + g[1] + 20))
                    : ((a = d.getSvgLeft(!0)),
                      l.axis_rotated
                          ? ((o = (r = a + g[0] + 100) + e), (c = d.currentWidth - d.getCurrentPaddingRight()), (s = d.x(t[0].x) + 20))
                          : ((o = (r = a + d.getCurrentPaddingLeft(!0) + d.x(t[0].x) + 20) + e), (c = a + d.currentWidth - d.getCurrentPaddingRight()), (s = g[1] + 15)),
                      o > c && (r -= o - c + 20),
        ...
        (C.showTooltip = function (t, e) {
            ...
            0 !== c.length &&
                o.tooltip_show &&
                (r.tooltip.html(o.tooltip_contents.call(r, t, r.axis.getXAxisTickFormat(), r.getYFormat(s), r.color)).style("display", "block"),
        ...
        (C.redrawForZoom = function () {
            ...
            if (i.zoom_enabled && 0 !== t.filterTargetsToShow(t.data.targets).length) {
                ...
                t.isCategorized() && a.orgDomain()[0] === t.orgXDomain[0] && a.domain([t.orgXDomain[0] - 1e-10, a.orgDomain()[1]]),
                    t.redraw({ withTransition: !1, withY: i.zoom_rescale, withSubchart: !1, withEventRect: !1, withDimension: !1 }),
